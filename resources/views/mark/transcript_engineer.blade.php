...
<!-- #########  Fourth Page Transcript End Here with Ten semester result #########-->
@if(count($semesters_4)>0)
<div class="container page-break break" >
    <br>
    <br>
  ...
  <div class="row" style="visibility:hidden;">
    ...
    <div class="row">
      ...
      </div><!-- Twelfth Semester Result End Here-->
...
@endif
<div class="container">
    <div class="row" style=" @if(count($semesters_4)>0)display:none  @endif">
        <div class="col-md-6">
          <br>
          <br>
