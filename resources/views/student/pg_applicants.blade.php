...
<div class="page-inner">
  ...
  @if($applicants)
      <div style="padding-left: 20px;">
          <a style="float: right;" class="btn btn-primary" href="{{ url()->previous() }}"><h3>Go Back</h3></a>
        </div>
    @endif
    <div class="col-md-12">
                  ...
                  @if(count($applicants)>0)
                    ...
                    @endphp
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-primary" href="/admin/view-pg-applicant/{{base64_encode($student->application_number)}}">View</a>
                        </td>
                      </tr>
                    @endforeach
                  @endif
