        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header">
              <div class="card-title"> All Jamb Students information upload using file.</div>
            </div>
                ...
                <div class="col-md-6 col-lg-4">
                  ...
                  <div class="form-group">
                    ...
                    <span id="msg_file" class="text-danger">{{ $errors->first('file') }}</span>
                      <br/>
                     <a href="/docs/sample_jamb.csv"><u>Download Sample CSV</u></a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-header">
              <div class="card-title"> All Direct Entry Students information upload using file.</div>
            </div>
            <form class="" action="{{route('student.importde')}}" method="POST" enctype="multipart/form-data">
              @csrf
            <div class="card-body">
              <div class="row">
                <div class="col-md-6 col-lg-4">
