                                    ...
                                    <div class="form-row">
                                       ...
                                       <div class="form-group col-lg-4 col-md-4 col-sm-3 col-xs-12">
                                            ...
                                            <input type="text" id="registration_number"
                                                ...
                                                placeholder="1101031" value="{{ old('registration_number') }}" required />
                                        ...
                                        <div class="form-group col-lg-4 col-md-4 col-sm-3 col-xs-12">
                                            ...
                                            <input type="text" id="matric_number"
                                                ...
                                                placeholder="14/234234" value="{{ old('matric_number') }}"  required />
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4 col-sm-12 col-xs-12">
                                            ...
                                            <input type="date" name="date_of_birth" id="date_of_birth"
                                                value="{{ old('date_of_birth') }}" class="form-control has-feedback-left"
                                        ...
                                        <div class="form-group col-md-4 col-sm-12 col-xs-12">
                                            ...
                                            <input type="text" class="form-control has-feedback-left"
                                                name="Student_Mobile_Number" value="{{old('Student_Mobile_Number')}}" minlength="11" maxlength="11" required/>
                                        ...
                                        <div class="form-group col-md-4 col-sm-12 col-xs-12">
                                            ...
                                            <input type="email" id="Email_Address" class="form-control has-feedback-left"
                                                name="Email_Address" data-parsley-trigger="change" value="{{old('Email_Address')}}" required />
                                ...
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3 col-sm-12 col-xs-12">
                                            ...
                                            <input type="text" value="{{ old('fathers_phone') }}"
                                        ...
                                        <div class="form-group col-md-3 col-sm-12 col-xs-12">
                                            ...
                                            <input type="text" value="{{ old('mothers_phone') }}"
                                ...
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            ...
                                            <input type="text" id="guardians_name" value="{{ old('guardians_name') }}"
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            ...
                                            <input type="text" id="guardians_relationship"
                                                class="form-control has-feedback-left" name="guardians_relationship" />
                                            {{-- <i class="fa fa-info form-control-feedback left" aria-hidden="true"></i> --}}
                                         ...
                                         <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <textarea id="guardians_address" 
                                                class="form-control has-feedback-left"
                                                placeholder=""
                                                name="guardians_address"></textarea>
                                            {{-- <i class="fa fa-home form-control-feedback left" aria-hidden="true"></i> --}}
                                ...
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            ...
                                            <input type="text" id="sponsors_name" value="{{ old('sponsors_name') }}"
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            ...
                                            <input type="text" id="sponsors_relationship"
                                                class="form-control has-feedback-left" name="sponsors_relationship"  />
                                            {{-- <i class="fa fa-info form-control-feedback left" aria-hidden="true"></i> --}}
                                         ...
                                         <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <textarea id="sponsors_address" 
                                                class="form-control has-feedback-left"
                                                placeholder=""
                                                name="sponsors_address"></textarea>
                                            {{-- <i class="fa fa-home form-control-feedback left" aria-hidden="true"></i> --}}
                    ...
                    <div class="ln_solid"></div>
                           <div class="form-group">
                             <div class="col-md-6 col-md-offset-3 btn-group">
                               <button id="send" type="submit" class="btn btn-success">Save Student</i></button>
                               &nbsp;
