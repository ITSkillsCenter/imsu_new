...
<div class="page-inner">
    ...
    <a href="/admin/staff-id-management" class="btn btn-primary">Back</a> <br><br>
    <div class="row">
                ...
                <div class="card-body ">
                    <div class="row">
                        ...
                        <div class="col-sm-7" style="margin-top: 10px;">
                            <h3>Name: <strong>{{$staff->name}}</strong></h3>
                            <h3>Faculty: <strong>{{Helper::get_faculty($staff->faculty_id)->name}}</strong></h3>
                            <h3>Department: <strong>{{Helper::get_department($staff->dept_id)->name}}</strong></h3>
