  ...
  <div class="" >
    <div class="row">
      <div class="col-md-12" id="hed">
        &nbsp;
        &nbsp;
        <h2 class="text-center" style="font-size:47px; visibility:hidden;" >Bangladesh Army International University of Science & Technology
        </h2>
    ...
    <div class="row">
      ...
      <div class="row">
        <div class="col-md-12  mt-2">
          <h4 id="prov" style="font-size:42px;margin-top:2px;margin-left:37%"><b>Provisional Certificate</b></h4>
          <h3 id="hed2" class="text-center" style="font-size:40px;"><b>{{$program}}</b></h3>
          <p id="it1" class="text-center" style="font-size:35px;"><b>This is to certify that<b></p>
          <h4 class="text-center" style="text-decoration: underline;"><b>{{$student->Full_Name}}</b></h4>
        </div>
      </div>
      <br>
      
      <div class="row" style="margin-left: 140px;margin-right: 150px;" >
        <div class="col-md-12" >
