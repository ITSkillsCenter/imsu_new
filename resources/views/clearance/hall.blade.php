...
@section('title', 'Hall Clearance Report')
@section('extrastyle')
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      @foreach($students as $reg)
                        <tr>
                          ...
                          <td>{{$reg->Full_Name}}</td>   
                      <td>
                         <a onclick="return confirm('Make sure you are approving Hostel clearance status!');"  id='{{$reg->id}}' href='{{URL::route('all.clearance',[$reg->id,'type'=>2])}}'>
                          <?php
