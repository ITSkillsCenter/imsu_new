                                        ...
                                        <div class="gdlr-core-pbf-element">
                                            <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr" style="padding-bottom: 60px ;">
                                                <div class="gdlr-core-title-item-title-wrap clearfix">
                                                    <h4 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 39px ;">Reset Password</h4>
                                                </div><span class="gdlr-core-title-item-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 14px ;font-style: normal ;text-transform: uppercase ;">Kindly reset your password</span>
                                            </div>
                                        </div>
                                        <div class="gdlr-core-pbf-element">
                                                        ...
                                                        <div class="quform-elements">
                                                            <div class="quform-element">
                                                                <p>Password
                                                                    ...
                                                                    <span class="wpcf7-form-control-wrap your-email">
                                                                        ...
                                                                        <input id="otp" type="text" name="password" class="input1" aria-required="true" required>
                                                            ...
                                                            <div class="quform-element">
                                                                <p>Confirm Password
                                                                    <br>
                                                                    <span class="wpcf7-form-control-wrap your-email">
                                                                        <input id="otp2" type="text" name="conf_password" class="input1" aria-required="true" required>
                                                                    </span>
                                                                </p>
                                                            </div>
                                                            <p>
