            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" novalidate method="post" action="{{URL::route('archive.update',$student->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input id="student_id" type="text" class="form-control"  name="student_id" value="{{$student->student_id}}"  required="required">
                              </div>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-envelope blue"></i></span>
                                <input type="file"  id="pvc" name="pvc"   class="form-control">
                              </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                <select name="status" id="" class="form-control">
                                  <option @if ($student->status==1)
                                      selected
                                  @endif value="0">Not withdraw</option>
                                  <option  @if ($student->status==1)
                                    selected
                                @endif  value="1">Withdraw</option>
                                </select>
                              </div>
