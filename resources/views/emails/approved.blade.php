      ...
      <tbody>
          ...
          >
            <center>
              ...
              <img
                ...
                src="https://imsu.edu.ng/homepage/images/logo.png"
              />
              <table
        ...
        <tr>
          ...
          >
            <br><br>
            <center>
              <table cellpadding="0" cellspacing="0" class="w320" width="600" style="text-align: center;">
                <tbody>
                  <tr>
                    <td class="header-lg"><h3>{{$data['title']}}</h3></td>
                  </tr>
                  <tr>
                    <td class="free-text">
                        {{$data['body']}}
                  ...
                  <tr>
                    <td class="button">
                      <div>
                        <a
                          class="button-mobile"
                          href="https://imsu.edu.ng/student-portal"
                          style="
