  ...
  <div class="row" style="visibility:hidden;">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        @if(count($ac_marks)>0)
        @if(($loop->index+1)==4 && $std->Program=='BBA')          
          <table class="table table-bordered" width="50%">
          <thead>
            <tr>
...
<div class="row">
  ...
  <div class="col-md-4">
    <br>
    <div id="grade"> 
        <div style="visibility:@if(count($semesters_3)>0) hidden @else none @endif;">
...
<div class="row" style="visibility:hidden;">
  ...
  <div class="row">
    <div class="col-md-12">
      <p><b>List of Waived Courses(Completed from ...University)</b></p>
      <table class="table table-bordered" width="1000%">
        ...
        <tbody>
          <tr>
            ...
            <td></td>
            <td></td>
            <td><b style="margin-left:15px;"></b></td>
