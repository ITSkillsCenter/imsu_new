                    ...
                    @method("PATCH")
                        ...
                        <div class="form-group">
                            ...
                            @foreach ($types as $item)
                                <option value="{{ $item->id }}" @if ($item->id == $event->type_id)
                                    selected
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="starts" value="{{ $event->starts }}"/>
                        </div>

                        <div class="form-group">
                            <label>Ends at: </label>
                            <input type="date" class="form-control" name="ends" value="{{ $event->ends }}"/>
                        </div>
