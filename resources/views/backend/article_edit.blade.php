@extends('layouts.master',['title'=>'Edit Article'])
...
<div class="page-inner">
    @include('layouts.includes.crumbMenu',['pageTitle'=>'Edit Article','Title'=>'Article'])

    <div class="row">
        <div class="col-md-12">
            <a href="/admin/article" class="col-md-2 btn btn-primary">Back</a>
                        ...
                        <div class="card no-margin-bottom">
                            ...
                            <div class="card-body" id="create-article">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="heading" id="title" value="{{$article->heading}}" required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="type" id="" class="form-control" required>
                                        ...
                                        <option value="event" {{$article->type == 'event' ? 'selected' : ''}}>Event</option>
                                        <option value="slider" {{$article->type == 'slider' ? 'selected' : ''}}>Slider</option>
                                        <option value="announcement" {{$article->type == 'announcement' ? 'selected' : ''}}>Announcement</option>
                                        <option value="menu" {{$article->type == 'menu' ? 'selected' : ''}}>Menu</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id" id="" class="form-control" required>
                                        ...
                                        <option value="{{ $cate->id }}" {{$article->category_id == $cate->id ? 'selected' : ''}}>{{ $cate->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="keywords" value="{{$article->keywords}}" id="keyword" required>
                                </div>
                                <div class="form-group">
                                    <label for="seo_descr">SEO Meta Description:</label>
                                    <textarea name="seo_description" id="seo_descr" class="form-control"></textarea>
                                </div>

                                <div class="checkbox">
                                    <label><input type="checkbox" value="1" name="is_comment_enabled" {{$article->is_comment_enabled == 1 ? 'checked' : ''}}> Allow comments for this article</label>
                                </div>
                                <div class="checkbox">
                                    <label><input type="checkbox" value="1" name="is_page" {{$article->is_page == 1 ? 'checked' : ''}}> This is a page not blog post</label>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="chibueze-zone">
                                    ...
                                    @if ($article->image)
                                    <div class="chibueze-zone__thumb"  data-label="{{$article->image}}" style="background-image: url('/uploads/images/articles/{{$article->image}}'); width:100%"></div>
                                    @endif
                                </div>
                            </div>
                        </div>
