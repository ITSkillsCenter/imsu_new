...
<div class="page-inner">
    @include('layouts.includes.crumbMenu',['pageTitle'=>'Borrowed Courses','Title'=>'Course'])
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="card-header">
                        <h4 class="card-title">No Borrowed Courses found in {{$department->name}} for {{$sel_prog->name}}</h4>
                    </div>
                    @endif

                    @if($prg == 2)
                    <div class="card-header">
                        <a href="/admin/course/programme/{{$department->id}}" class="btn btn-primary">Borrow Course</a>
                    </div>
                    @endif
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>Borrowed Courses for Approval</h4>
                </div>
                <div class="card-body">
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$course->type}}</td>
                                    <td>{{$course->unit}}</td>
                                    <td>{{Helper::get_department($course->dept_borrow_id)->name}}</td>
                                    <td>
                                        <div class="btn-group">
                                            @if($course->bstatus == 'pending')
                                            <a href="/admin/toggle-borrow/{{$course->bid}}/accepted" class="btn btn-sm btn-primary">Accept</a>
                                            <a href="/admin/toggle-borrow/{{$course->bid}}/rejected" class="btn btn-sm btn-danger">Reject</a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
