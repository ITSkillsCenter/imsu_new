...
<head>
    ...
    <title>Imo State Univeristy</title>
    <!-- Favicon -->
    <link rel="shortcut icon" href="https://imsu.edu.ng/homepage/favicon.jpg" type="image/x-icon">
    <link rel="icon" href="https://imsu.edu.ng/homepage/favicon.jpg" type="image/x-icon">
    ...
    <link rel="stylesheet" href="/assets/plugins/components/animate.min.css@f7a307d5d6b1748af3468afbea376c25.css">
...
<body class="home page-template-default page page-id-2039 gdlr-core-body woocommerce-no-js tribe-no-js kingster-body kingster-body-front kingster-full  kingster-with-sticky-navigation  kingster-blockquote-style-1 gdlr-core-link-to-lightbox new-styled">
    <div class="kingster-mobile-header-wrap">
        <div class="kingster-mobile-header kingster-header-background kingster-style-slide kingster-sticky-mobile-navigation" id="kingster-mobile-header">
            <div class="kingster-mobile-header-container kingster-container clearfix">
                <div class="kingster-logo kingster-item-pdlr">
                    <div class="kingster-logo-inner">
                        <a class="" href="/"><img src="https://imsu.edu.ng/homepage/images/logo.png" alt="" /></a>
                    </div>
                </div>
                ...
                <div class="kingster-top-bar-container kingster-container">
                    <div class="kingster-top-bar-container-inner clearfix">
                        <div class="kingster-top-bar-left kingster-item-pdlr">
                            <i class="bx bx-envelope-open" id="i_fd84_0"></i>
                            <span class="__cf_email__" data-cfemail="046d6a626b446d6977712a6160712a6a63"><a href="mailto:info@imsu.edu.ng">info@imsu.edu.ng</a></span>
                            <!-- <i class="icofont-phone" id="i_fd84_1"></i> -->
                        </div>
                        <div class="kingster-top-bar-right kingster-item-pdlr">
                            <ul id="kingster-top-bar-menu" class="sf-menu kingster-top-bar-menu kingster-top-bar-right-menu">
                                ...
                                <li class="menu-item kingster-normal-menu">
                                    <a href="https://imsu.edu.ng/contacts">Contacts</a>
                                </li>
                        ...
                        <div class="kingster-navigation kingster-item-pdlr clearfix">
                            <div class="kingster-main-menu" id="kingster-main-menu">
                                <ul id="menu-main-navigation-1" class="sf-menu">
                                    <li class="menu-item menu-item-home current-menu-item kingster-normal-menu">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li class="menu-item" data-size="20">
                                                    <div class="kingster-mega-menu-section-content">
                                                        <h4>About Us</h4>
                                                        <span id="span_fd84_0">
                                                            The Imo State University (IMSU) was established
                                                            ...
                                                            well as an agent for development.
                                                        </span>
                                                    </div>
                                                </li>
                                            </ul>
            ...
            <footer>
                        ...
                        <div class="kingster-footer-column kingster-item-pdlr kingster-column-15">
                            <div id="text-2" class="widget widget_text kingster-widget">
                                <div class="textwidget">
                                    <p>
                                        <img src="https://imsu.edu.ng/homepage/images/logo.png" alt="" style="background: white; padding: 10px" />
                                        <br />
                            ...
                            <div id="gdlr-core-custom-menu-widget-2" class="widget widget_gdlr-core-custom-menu-widget kingster-widget">
                                ...
                                <div class="menu-our-campus-container">
                                    <ul id="menu-our-campus" class="gdlr-core-custom-menu-widget gdlr-core-menu-style-plain">
                                        <li class="menu-item"><a href="https://imsu.edu.ng/contacts">Contacts</a></li>
                ...
                <div class="kingster-copyright-wrapper">
                    <div class="kingster-copyright-container kingster-container clearfix">
                        <div class="kingster-copyright-left kingster-item-pdlr">Copyright All Right Reserved <span class="year"></span>, Imo State University, Owerri.</div>
