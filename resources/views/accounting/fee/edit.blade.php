                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                          <form class="form-horizontal form-label-left" novalidate method="post" action="{{route('fee.update',$fee->id)}}">
                            @csrf
                      {{method_field('put')}}
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <input id="fee_name" type="text" class="form-control col-md-12 col-sm-12 col-xs-12"  name="fee_name" value="{{ $fee->fee_name }}">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <select class="form-control col-md-12 col-sm-12 col-xs-12" name="account_type" required="required">
                            <option selected  value="{{ $fee->account_type }}">{{ $fee->account_type }}</option>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <select class="form-control col-md-12 col-sm-12 col-xs-12" name="section" required="required">
                            <option selected  value="{{ $fee->section }}">{{ $fee->section }}</option>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="croutine_id">Status
                        </label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
