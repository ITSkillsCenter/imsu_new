                  ...
                  <div class="col-md-5">
                    <div class="item form-group">
                      <label class="control-label " for="department">Department <span class="required">*</span>
                             ...
                             <?php
        $departments = DB::table('departments')->select('id','name')->orderby('name','asc')->get('name', 'id');
                       ?>
                  ...
                  <div class="col-md-2">
                    <div class="item form-group">
                      <label class="control-label" for="session">Session <span class="required">*</span>
                       ...
                       <?php
        $sessions = DB::table('students')->select('session')->distinct()->get();
                       ?>
                        <select class="form-control session  has-feedback-left" name="session" id="session">
                            <option selected disable> --Select Sessions--</option>
