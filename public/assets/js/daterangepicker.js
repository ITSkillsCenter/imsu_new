      ...
      (r += '<table class="table-condensed">'),
        ...
        (r +=
          !a || a.isBefore(t.firstDay)
            ? '<th class="prev available"><i class="fa fa-arrow-left icon icon-arrow-left fa fa-arrow-left"></i></th>'
            : "<th></th>");
      ...
      this.showDropdowns && (o = this.renderDropdowns(t[1][1], a, s)),
        ...
        (r +=
          !s || s.isAfter(t.lastDay)
            ? '<th class="next available"><i class="fa fa-arrow-right icon icon-arrow-right fa fa-arrow-right"></i></th>'
            : "<th></th>"),
        (r += "</tr>"),
        (r += "<tr>"),
