...
Route::group(['prefix' => '/admin', 'middleware' => ['2fa', 'auth']], function () {
  ...
  */
  ...
  Route::get('/applicant/view-by-dept/{year}/{type}/{id}', 'StudentinfoExportImportController@viewjamb_bydept');
...
Route::get('/', 'HomeController@homepage2');
Route::get('/home', 'HomeController@homepage');
Route::get('/pg', 'HomeController@pg');
